...
<body style="margin-bottom: 70px;" class="bg-light">
    ...
    <script>
        ...
        $(document).on('keyup', '.indonesia', function(e) {
            e.preventDefault();
            ...
            let val = $(this).val();
            let id = $(this).data('id');
            let indonesia_id = $(this).data('indonesia_id');

            indonesia(order, col, val, indonesia_id, id);
        });
        $(document).on('click', '.cancel_indonesia', function(e) {
            e.preventDefault();
            ...
            let val = $(this).val();
            let id = $(this).data('id');
            cancel_indonesia(order, col, val, id);
        });
        $(document).on('click', '.insert_indonesia', function(e) {
            ...
            insert_indonesia(order, col, val, indonesia_id, id);
        });
